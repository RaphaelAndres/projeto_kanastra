                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <svg class="w-8 h-8 text-gray-500" height="30px" width="30px" fill="#747474" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.955 490.955" xml:space="preserve">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href={{route('invoiceUpload')}} class="underline text-gray-900 dark:text-white">Upload de CSV</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Você pode realizar o upload dos documentos de débitos por aqui!
                                </div>
                            </div>
                        </div>
                    </div>
